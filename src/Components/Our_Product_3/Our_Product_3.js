  ...
  return (
    <section className="Ourproducts-container">
      ...
      >
        ...
        >
          <h3
            className="text-uppercase text-dark fw-bold products_head_text"
            style={{
              fontSize: "30px",
              padding: "20px 50px",
            ...
            >
              ...
              <div className="d-flex justify-content-center align-items-center product_ID">
                ...
                >
                  <div>
                    <h4
                      className="mb-auto fw-bold text-dark"
                      style={{
                        fontSize: "12px",
                        width: "10rem",
                        fontFamily: "'Inter', sans-serif",
